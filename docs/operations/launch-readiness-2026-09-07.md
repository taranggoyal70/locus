...
|---|---|---|
| Repository integrity, tests, typecheck, build, and dependency audit | **FAIL** | Last retained pass was revision `86e8994`. Re-run the full preflight for the final reviewed revision before opening admission |
