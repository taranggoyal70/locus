      ...
      <main className="mx-auto max-w-5xl px-5 py-12 sm:px-8 sm:py-16">
        <div className="text-center">
          ...
          <h1 className="mt-4 font-display text-4xl font-semibold tracking-[-0.05em] text-paper sm:text-6xl">
            Repo localization is open. Agent Runs stay access-gated until the production canary passes.
          </h1>
          <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-muted-light sm:text-lg">
            ...
            Enabled beta accounts can use one shared daily slot or capacity they connect. We are
            inviting a smaller group to test complete Agent Runs before introducing paid plans.
          </p>
        </div>
