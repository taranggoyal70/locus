      ...
      <div className="mx-auto max-w-[1480px] px-4 pb-10 pt-6 sm:px-6 lg:px-8 lg:pb-16">
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-white/15 pb-4">
          <div className="flex flex-wrap items-center gap-2">
            <span className="rounded-full border border-[#8ef0c0]/35 bg-[#8ef0c0]/10 px-3 py-1 font-mono text-[9px] font-semibold uppercase tracking-[0.16em] text-[#8ef0c0]">
              Interactive vision demo
            </span>
            <span className="font-mono text-[9px] uppercase tracking-[0.14em] text-[#a7b7c7]">
              Fictional data · simulated sequence · no external writes
            </span>
          </div>
          <Link href="/workspace" className="font-mono text-[10px] font-semibold uppercase tracking-[0.12em] text-[#d7e2ec] transition hover:text-[#8ef0c0]">
        ...
        <header className="grid gap-7 py-10 lg:grid-cols-[minmax(0,1fr)_360px] lg:items-end lg:py-14">
          <div>
            <p className="font-mono text-[10px] font-semibold uppercase tracking-[0.18em] text-[#8ef0c0]">A proposed first workflow</p>
          ...
          <div className="grid min-h-[620px] lg:grid-cols-[minmax(260px,.72fr)_minmax(440px,1.2fr)_minmax(320px,1fr)]">
            <section className="border-b border-white/15 p-5 sm:p-7 lg:border-b-0 lg:border-r" aria-labelledby="provider-change-title">
              <div className="flex items-center justify-between gap-3">
                <p className="font-mono text-[9px] font-semibold uppercase tracking-[0.16em] text-[#91a4b6]">Provider signal</p>
                <span className="rounded-full border border-[#e7b853]/30 bg-[#e7b853]/10 px-2.5 py-1 font-mono text-[8px] uppercase tracking-[0.12em] text-[#f2c76d]">Breaking</span>
              </div>
              ...
              <div className="mt-7 rounded-2xl border border-white/10 bg-white/[.035] p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 font-mono text-[9px] uppercase tracking-[0.1em] text-[#91a4b6]">Published 09:42 UTC</p>
                  </div>
                </div>
                <div className="mt-5 space-y-3 font-mono text-[11px] leading-5">
              ...
              <div className="mt-7 border-t border-white/10 pt-6">
                <p className="font-mono text-[9px] uppercase tracking-[0.14em] text-[#91a4b6]">Target repository</p>
                ...
                <div className="mt-4 grid grid-cols-2 gap-3">
                  <div className="rounded-xl border border-white/10 p-3">
                    ...
                    <p className="mt-1 font-mono text-[8px] uppercase tracking-[0.12em] text-[#91a4b6]">Repo files</p>
                  </div>
                  <div className="rounded-xl border border-white/10 p-3">
                    <p className="font-display text-2xl font-semibold text-white">6</p>
                    <p className="mt-1 font-mono text-[8px] uppercase tracking-[0.12em] text-[#91a4b6]">Known usages</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="relative flex min-h-[560px] flex-col items-center justify-center overflow-hidden border-b border-white/15 p-5 sm:p-7 lg:border-b-0 lg:border-r" aria-label="Repository aperture visualization">
              ...
              <div className="absolute left-5 top-5 z-10 sm:left-7 sm:top-7">
                <p className="font-mono text-[9px] font-semibold uppercase tracking-[0.16em] text-[#91a4b6]">Repository aperture</p>
              ...
              <div className="migration-aperture relative mt-14 aspect-square w-full max-w-[440px]" aria-hidden="true">
                ...
                <div className="migration-aperture__core absolute inset-[28%] grid place-items-center rounded-full border border-[#8ef0c0]/35 bg-[#0d1a2d]/95 text-center shadow-[0_0_70px_rgba(142,240,192,.12)]">
                  <div>
                    ...
                    <p className="mt-1 font-mono text-[8px] font-semibold uppercase tracking-[0.16em] text-[#8ef0c0]">{stage >= 2 ? "files admitted" : "files observed"}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative z-10 mt-4 grid w-full max-w-md grid-cols-3 gap-px overflow-hidden rounded-xl border border-white/10 bg-white/10 text-center">
                <div className="bg-[#0d1a2d] p-3"><p className="font-mono text-[8px] uppercase tracking-[0.12em] text-[#91a4b6]">Admitted</p><p className="mt-1 text-sm font-semibold text-[#8ef0c0]">{stage >= 2 ? "7" : "—"}</p></div>
                <div className="bg-[#0d1a2d] p-3"><p className="font-mono text-[8px] uppercase tracking-[0.12em] text-[#91a4b6]">Excluded</p><p className="mt-1 text-sm font-semibold text-white">{stage >= 2 ? "1,835" : "—"}</p></div>
                <div className="bg-[#0d1a2d] p-3"><p className="font-mono text-[8px] uppercase tracking-[0.12em] text-[#91a4b6]">Widened</p><p className="mt-1 text-sm font-semibold text-white">{stage >= 2 ? "0" : "—"}</p></div>
              </div>
            </section>

            <section className="relative flex flex-col p-5 sm:p-7" aria-labelledby="proposal-title">
              <div className="flex items-center justify-between gap-3">
                <p className="font-mono text-[9px] font-semibold uppercase tracking-[0.16em] text-[#91a4b6]">Proposed change</p>
                <span className={`rounded-full border px-2.5 py-1 font-mono text-[8px] uppercase tracking-[0.12em] ${stage >= 4 ? "border-[#8ef0c0]/30 bg-[#8ef0c0]/10 text-[#8ef0c0]" : "border-white/15 text-[#91a4b6]"}`}>
              ...
              <div aria-hidden={stage < 3} className={`migration-diff mt-6 overflow-hidden rounded-2xl border border-white/10 bg-[#081322] transition ${stage >= 3 ? "migration-diff--visible" : ""}`}>
                <div className="flex items-center justify-between border-b border-white/10 px-4 py-3">
                  <p className="font-mono text-[9px] text-[#d7e2ec]">src/server/payments.ts</p>
                  <p className="font-mono text-[8px] text-[#91a4b6]">+4 −1</p>
                </div>
                <div className="overflow-x-auto py-3 font-mono text-[10px] leading-6">
              ...
              <div className="mt-5 space-y-2.5">
                {[
                  ...
                  <div aria-hidden={stage < 3} key={label} className={`migration-check flex items-center justify-between rounded-xl border border-white/10 px-3.5 py-3 ${stage >= 3 ? "migration-check--visible" : ""}`} style={{ transitionDelay: `${420 + index * 110}ms` }}>
                    <span className="font-mono text-[9px] text-[#bdcad8]">{label}</span>
                    <span className="flex items-center gap-2 font-mono text-[9px] font-semibold text-[#8ef0c0]"><span aria-hidden="true">✓</span>{value}</span>
                  </div>
                ))}
              </div>
              ...
              {stages.map((item, index) => {
                ...
                return (
                  <button key={item.label} type="button" onClick={() => inspect(itemStage)} className={`rounded-xl px-3 py-3 text-left transition ${active ? "bg-white/10" : "hover:bg-white/[.05]"}`} aria-current={active ? "step" : undefined}>
                    <span className="flex items-center gap-2 font-mono text-[9px] font-semibold uppercase tracking-[0.12em] text-white">
                      <span className={`grid h-5 w-5 place-items-center rounded-full border text-[8px] ${active || complete ? "border-[#8ef0c0] bg-[#8ef0c0] text-[#14233b]" : "border-white/20 text-[#91a4b6]"}`}>{complete ? "✓" : itemStage}</span>
                      {item.label}
                    </span>
                    <span className="mt-2 hidden text-[10px] leading-4 text-[#91a4b6] sm:block">{item.note}</span>
                  </button>
                );
              })}
            </div>
        ...
        <section className="mt-8 grid gap-4 md:grid-cols-2" aria-label="Demo capability boundaries">
          <div className="rounded-2xl border border-white/15 bg-white/[.035] p-5">
            <p className="font-mono text-[9px] font-semibold uppercase tracking-[0.14em] text-[#8ef0c0]">Real in early access today</p>
          ...
          <div className="rounded-2xl border border-[#e7b853]/20 bg-[#e7b853]/[.04] p-5">
            <p className="font-mono text-[9px] font-semibold uppercase tracking-[0.14em] text-[#f2c76d]">Being validated next</p>
